...
urlpatterns = [
    # /ambulance
    url(r'^$', AmbulanceLV.as_view(), name='index'),
    # url(r'^bookmark/adult/(?P<pk>\d+)/$', BookmarkDV.as_view(), name='adult',
    url(r'^$', AmbulanceDV.as_view(), name='detail'

    ),

    # Example: /add/
    url(r'^add/$',
        AmbulanceCreateView.as_view(), name="add",
    ),

    # Example: /change/
    url(r'^change/$',
        AmbulanceChangeLV.as_view(), name="change",
    ),

    # Example: /99/update/
    url(r'^(?P<pk>[0-9]+)/update/$',
        AmbulanceUpdateView.as_view(), name="update",
    ),

    # Example: /99/delete/
    url(r'^(?P<pk>[0-9]+)/delete/$',
        AmbulanceDeleteView.as_view(), name="delete",
    ),
]
