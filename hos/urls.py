...
urlpatterns = [
    # /hos
    url(r'^$', HosLV.as_view(), name='index'),
    # url(r'^bookmark/adult/(?P<pk>\d+)/$', BookmarkDV.as_view(), name='adult',
    url(r'^$', HosDV.as_view(), name='detail'

    ),

    # Example: /add/
    url(r'^add/$',
        HosCreateView.as_view(), name="add",
    ),

    # Example: /change/
    url(r'^change/$',
        HosChangeLV.as_view(), name="change",
    ),

    # Example: /99/update/
    url(r'^(?P<pk>[0-9]+)/update/$',
        HosUpdateView.as_view(), name="update",
    ),

    # Example: /99/delete/
    url(r'^(?P<pk>[0-9]+)/delete/$',
        HosDeleteView.as_view(), name="delete",
    ),
]
