...
from phar.views import *

urlpatterns = [
    # /phar
    url(r'^$', PharLV.as_view(), name='index'),
    # url(r'^bookmark/adult/(?P<pk>\d+)/$', BookmarkDV.as_view(), name='adult',
    url(r'^$', PharDV.as_view(), name='detail'

    ),

    # Example: /add/
    url(r'^add/$',
        PharCreateView.as_view(), name="add",
    ),

    # Example: /change/
    url(r'^change/$',
        PharChangeLV.as_view(), name="change",
    ),

    # Example: /99/update/
    url(r'^(?P<pk>[0-9]+)/update/$',
        PharUpdateView.as_view(), name="update",
    ),

    # Example: /99/delete/
    url(r'^(?P<pk>[0-9]+)/delete/$',
        PharDeleteView.as_view(), name="delete",
    ),
]
